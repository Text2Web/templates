...
<head>
    ...
    ${tagHelper.addCssTag("/asset/css/404.css")}
</head>
<body>

<div class="main">
    <div class="text-center">
        <a class="btn btn-primary" href="${ tagHelper.twUrlWithExtension("/") }">Back to Home</a>
    </div>
    <div>
            ...
            <g id="train">
                ...
                <g id="car-layers">
                    ...
                    <g id="Text">
                        ...
                        <text transform="translate(580.5 213.994)" class="st8 st10" font-size="24.025">
                           Opss! The page not found.
                        </text>
                    </g>
                    <g id="ladders">
                        <g id="ladder-f">
